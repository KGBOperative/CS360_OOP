...
public class RectangleDialog extends JDialog implements ActionListener {
    ...
    public RectangleDialog(JFrame frame, boolean modal, int x, int y, int R, int R2) {
        super(frame, modal);
        oldSide = R;
        oldSide2 = R2;
        myPanel = new JPanel();
    ...
    private void addTextAndButtons () {
        ...
        sideText = new JTextField(((Integer) oldSide).toString() + " " + ((Integer) oldSide2).toString(), 20);
